...
const FULL_PANELS: Record<string, PanelConfig> = {
  // WW3 Monitor mode (conflict-only focus)
  map: { name: 'WW3 Conflict Map', enabled: true, priority: 1 },
  'live-news': { name: 'War Headlines', enabled: true, priority: 1 },
  insights: { name: 'Conflict Insights', enabled: true, priority: 1 },
  'strategic-posture': { name: 'Strategic Posture', enabled: true, priority: 1 },
  cii: { name: 'Country Instability', enabled: true, priority: 1 },
  'strategic-risk': { name: 'Escalation Risk', enabled: true, priority: 1 },
  intel: { name: 'Intel Feed', enabled: true, priority: 1 },
  'gdelt-intel': { name: 'Live Intelligence', enabled: true, priority: 1 },
  politics: { name: 'Conflict News', enabled: true, priority: 1 },
  us: { name: 'US Security', enabled: true, priority: 1 },
  europe: { name: 'Europe Conflict', enabled: true, priority: 1 },
  middleeast: { name: 'Middle East Conflict', enabled: true, priority: 1 },
  africa: { name: 'Africa Conflict', enabled: true, priority: 1 },
  latam: { name: 'Latin America Security', enabled: true, priority: 1 },
  asia: { name: 'Asia-Pacific Conflict', enabled: true, priority: 1 },
  gov: { name: 'Defense & Government', enabled: true, priority: 1 },
  thinktanks: { name: 'Security Think Tanks', enabled: true, priority: 1 },
  'ucdp-events': { name: 'UCDP Conflict Events', enabled: true, priority: 1 },
  displacement: { name: 'War Displacement', enabled: true, priority: 2 },
  'satellite-fires': { name: 'Battlefield Fires', enabled: true, priority: 2 },
  'security-advisories': { name: 'Security Advisories', enabled: true, priority: 2 },
  monitors: { name: 'War Monitors', enabled: true, priority: 2 },

  // Force-disable non-war/financial/tech content
  'live-webcams': { name: 'Live Webcams', enabled: false, priority: 3 },
  cascade: { name: 'Infrastructure Cascade', enabled: false, priority: 3 },
  ...
  giving: { name: 'Global Giving', enabled: false, priority: 3 },
  climate: { name: 'Climate Anomalies', enabled: false, priority: 3 },
  'population-exposure': { name: 'Population Exposure', enabled: false, priority: 3 },
};
